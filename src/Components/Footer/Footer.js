      ...
      <div className="footer__container">
        <div className="footer__start">
          ...
          <h1
            ...
            onClick={() => window.open(`https://code2rithik.github.io/`, "_blank")}
          >
            By <span className="footer__link">Rithik Samanthula</span>
          </h1>
        </div>
        ...
        <div
          ...
          onClick={() =>
            window.open(`https://github.com/Code2Rithik`, "_blank")
          }
        >
